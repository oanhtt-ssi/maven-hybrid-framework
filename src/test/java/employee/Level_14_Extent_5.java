...
public class Level_14_Extent_5 extends BaseTest {
    ...
    public void Employee_02_ViewEmployee(Method method){
        ...
        ExtentManager.getTest().log(Status.INFO,"Enter to FirstName and LastName with info: " + firstName + " | " +  lastName);
    ...
    public void Employee_03_EditEmployee(Method method){
        ...
        ExtentManager.getTest().log(Status.INFO,"Navigate to Personal Details page ");
    ...
    public void Employee_04_RemoveEmployee(Method method){
        ...
        ExtentManager.getTest().log(Status.INFO,"Verify Employee infor displayed: " + firstName + " | " +lastName + " | " + employeeID);
